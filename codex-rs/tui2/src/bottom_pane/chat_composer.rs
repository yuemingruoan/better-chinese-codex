...
impl ChatComposer {
    ...
    pub fn attach_image(&mut self, path: PathBuf) {
        ...
        self.attach_image_with_placeholder(placeholder, ImageAttachment::LocalPath(path));
    }
    ...
    fn attach_image_with_label(
        ...
        self.attach_image_with_placeholder(placeholder, attachment);
    }

    fn attach_image_with_placeholder(&mut self, placeholder: String, attachment: ImageAttachment) {

...
- GitHub workflows remain deleted when syncing from upstream, except `.github/workflows/build-platform-binaries.yml`; do not sync other upstream automation workflows.
